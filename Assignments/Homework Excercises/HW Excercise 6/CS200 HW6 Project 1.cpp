...
void DisplayStudents(const Student* studentList, int studentCount)
{
	for (int i = 0; i < studentCount; i++)
	{
		...
		cout << setw(30) << "CLASSES: " << studentList[i].classes[0] << " " << studentList[i].classes[1] << " " << studentList[i].classes[2] << " " << studentList[i].classes[3] << endl;
	}
}
