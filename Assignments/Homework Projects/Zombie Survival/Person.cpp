...
{
	if (m_health == 0) {
		cout << m_name << ":\t" << "Health: " << m_health << "%\t" << "Hunger: " << m_hunger << "%" << " (dead)" << endl << endl;
	}
	else {
		cout << m_name << ":\t" << "Health: " << m_health << "%\t" << "Hunger: " << m_hunger << "%" << endl << endl;
	}
}
...
void Person::Hurt( int amount )
{
	if (m_health > 0) {
		...
		cout << m_name << " received " << amount << " damage!" << endl;
		if (m_health <= 0) {
			m_health = 0;
			cout << m_name << " has died!" << endl;
		}
...
{
	cout << m_name << " eats " << amount << " unit(s) of food." << endl;
